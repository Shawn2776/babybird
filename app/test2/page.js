          ...
          {talkQuery?.data?.map((talk) => (
            <div key={talk.id} className="container px-4 mx-auto ">
              ...
              <div className="grid grid-cols-1 gap-4 py-4 md:grid-cols-3">
                ...
                <div className="md:p-4 border border-b-transparent border-l-transparent border-r-transparent md:border-none md:my-1 text-white border-gray-600 md:rounded-lg bg-[#333] ">
                  <div
                    id="talkTopRow"
